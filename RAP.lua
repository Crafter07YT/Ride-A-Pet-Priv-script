...
A.Colors={Surface=Color3.fromRGB(12,12,14),Text=Color3.fromRGB(245,245,245),
    Title=Color3.fromRGB(28,28,31),Border=Color3.fromRGB(70,70,76),
    Row=Color3.fromRGB(25,25,28),RowAlternate=Color3.fromRGB(20,20,23),
    Muted=Color3.fromRGB(155,155,162),Accent=Color3.fromRGB(235,235,235),
    Button=Color3.fromRGB(38,38,42),Good=Color3.fromRGB(220,220,225)}
A.Controls={}
A.Pages={}
